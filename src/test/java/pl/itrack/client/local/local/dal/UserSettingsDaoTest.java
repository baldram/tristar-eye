...
package pl.itrack.client.local.local.dal;
...
public class UserSettingsDaoTest {
    ...
    @Test
    public void retrieveStoredUserSettings() {
    ...
    private void mockUserSettingsEntityManager(UserSettings userSettings) {
        when(entityManager.find(Matchers.anyObject(), eq(UserSettings.FIRST_ROW))).thenReturn(userSettings);
    }

    @Test
    public void tryToRetrieveWhenNoDataStoredYet() {
