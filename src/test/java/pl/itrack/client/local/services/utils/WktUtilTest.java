...
public class WktUtilTest {
    ...
    private static final double COORDINATE_X = 2065593.15287473;
    private static final double COORDINATE_Y = 7257176.57009129;

    private final WktUtil wktUtil = new WktUtil();
    ...
    @Test
    public void ignoreInvalidData() throws Exception {
        String input = "[? (? ?)]";
